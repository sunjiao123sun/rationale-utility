...
parser.add_argument("--train_path", "-i", help="the path for training data",
                    default="../processed-data/cose-v1-0/train.csv")
parser.add_argument("--test_path", "-t", help="the path for the test data",
                    default="../processed-data/cose-v1-0/dev.csv")
parser.add_argument("--data_record", "-d", default="../hf-prepare")
...
# if "ecqa" not in train_path:
#     train_df = i2o_df(train_path, use_rationale, data_record)
#     dev_df = i2o_df(dev_path, use_rationale, data_record)
# else:
